...
import brokerNetworkRouter from './routes/broker-network.js';
...
export function createApp(): express.Express {
  ...
  app.use('/api/v1/broker-network', brokerNetworkRouter);
  ...
  app.use('/api/broker-network', brokerNetworkRouter);
